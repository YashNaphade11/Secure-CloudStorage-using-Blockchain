...
<html>
    ...
    <center>
        ...
        <%}
            ...
            %>
        <h2>Cloud Usage Report for <%=request.getParameter("cmbmon")%>/<%=request.getParameter("cmbyr")%> </h2></center>
    ...
    <table width="950" cellspacing="0" border="1" cellpadding="7" align="center" class="table table-bordered tblform">
        ...
        String cmonth=request.getParameter("cmbmon");
          ...
          rent.clear();
          rent=obj.getRent();
          Vector vnm=sf.getValue("select usernm from users where userid='"+vt.elementAt(i).toString()+"'", 1);
        %>
        
            
       
                <tr>
                    <td ><%=vnm.elementAt(0).toString() %></td>
                    ...
                    for(int j=0;j<s;j++)
                    {
                        ...
                        totusage+=Integer.parseInt(usage.elementAt(j).toString());
