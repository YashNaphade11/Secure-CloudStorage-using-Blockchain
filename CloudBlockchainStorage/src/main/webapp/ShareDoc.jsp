...
Vector v=jf.getValue("select usernm from accessperdocgroup where docid="+request.getAttribute("docid").toString().trim(), 1);
...
<div class="col-md-6">
<h2>Available Users</h2><br/>
<%
List<Users> lst=(ArrayList<Users>)request.getAttribute("lst");
if(lst.size()>0)
{
%>
...
<c:forEach var="userdsc" items="${lst}">
		<tr>  	<th colspan="2">
<input type="checkbox" name="${userdsc.usernm}" value="${userdsc.userid}"/>
...
<div class="col-md-6">
<h2>Selected Document already Shared with following Groups</h2>
<table class="table table-bordered">
<tr><th>Group Name</th>
</tr>
