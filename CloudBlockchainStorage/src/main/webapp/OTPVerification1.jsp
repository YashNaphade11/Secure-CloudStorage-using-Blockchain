...
<div class="col-md-12"> <h2> Secrete key Authentication</h2>
   <div class="form-group"> 
    <form method="post" name="frm" action="OTPAuth1">
<table class="tblform">
<tr><td colspan="2">Enter Secrete key is sent on your registered email id!!</td></tr>
<tr>
...
<input type="hidden" value="<%=request.getAttribute("path").toString().trim() %>" name="filePath"/>
 ...
 <tr><td colspan="2"><input type="text" value="<%=request.getAttribute("otp").toString().trim() %>" name="otp"/></td></tr>
</table></form><!-- 
