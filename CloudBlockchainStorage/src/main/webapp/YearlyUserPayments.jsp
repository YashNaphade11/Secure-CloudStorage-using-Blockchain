...
%>
    <center>  <jsp:include page="Top.jsp"/>
       ...
       java.util.Vector vt=ff.getValue("select userid,usernm from users where usertype='user'  ", 2);
...
<br/>
        ...
        <table align="center"  >
            <tr>
                <td>
                    <input type="hidden" value='<%=session.getAttribute("userid").toString() %>' name="cmbcust" class="form-control" style="width:80px"/>
                            </td>
