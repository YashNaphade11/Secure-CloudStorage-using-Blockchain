...
from Cryptography import decryption
...
key1,docpath,userid = message.split('|')
...
doc1 = bytearray(doc)
"""
dfile=decryption(docpath,ext,(key1),docid)
 
print("<html>")
print("<head>")
print("<meta http-equiv='refresh' content='0;url=http://localhost:8080/FromPythonDec?userid="+userid+"&sts="+dfile+"'/>")
print("</head>")
print("</html>")
